...
export function ChangePasswordPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 p-6 w-full">
      <div className="w-full max-w-md rounded-lg border border-zinc-200 bg-white shadow-card overflow-hidden">
        <div className="p-6 sm:p-8">
          <div className="flex items-start gap-3 mb-6">
            ...
            <div>
              <h1 className="text-base font-medium text-zinc-900">Choose a new password</h1>
          ...
          <ul className="text-xs text-zinc-600 space-y-1 mb-6 list-disc list-inside border border-zinc-100 rounded-md bg-zinc-50/80 px-3 py-2">
