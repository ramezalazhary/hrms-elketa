...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f5f5f7] px-6 py-10 font-sans text-zinc-900">
      ...
      <div className="relative w-full max-w-[960px] overflow-hidden rounded-[32px] border border-white/70 bg-white/85 shadow-[0_30px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl">
        <div className="grid min-h-[680px] lg:grid-cols-[1.05fr_0.95fr]">
          <section className="hidden flex-col justify-between bg-[linear-gradient(180deg,#fbfbfd_0%,#f2f4f7_100%)] p-10 lg:flex">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-zinc-200/80 bg-white/80 px-4 py-2 text-[11px] font-medium tracking-[0.18em] text-zinc-500 uppercase">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={item}
                  className="flex items-start gap-3 rounded-2xl border border-zinc-200/70 bg-white/75 px-4 py-4 shadow-sm"
                >
          ...
          <section className="flex items-center justify-center px-6 py-10 sm:px-10">
            <div className="w-full max-w-[380px]">
              ...
              <form
                ...
                className="space-y-5 rounded-[28px] border border-zinc-200/80 bg-white/95 p-6 shadow-[0_20px_50px_rgba(15,23,42,0.06)] sm:p-7"
              >
                <div className="space-y-2">
                  <label className="block text-xs font-semibold tracking-wide text-zinc-600">
                    Email address
                  </label>
                  <div className="flex items-center gap-3 rounded-2xl border border-zinc-200 bg-zinc-50/80 px-4 py-3 transition focus-within:border-zinc-300 focus-within:bg-white focus-within:ring-4 focus-within:ring-zinc-200/60">
                    ...
                    <input
                      ...
                      className="w-full border-0 bg-transparent p-0 text-sm text-zinc-900 placeholder-zinc-400 outline-none"
