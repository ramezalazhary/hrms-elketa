                  ...
                  >
                    ...
                    {!isRejecting && (
                      <div className="flex shrink-0 gap-2">
                        ...
                        <button
                          className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3.5 py-2 text-xs font-medium text-zinc-700 shadow-sm hover:bg-zinc-50 disabled:opacity-50"
                          disabled={isBusy}
