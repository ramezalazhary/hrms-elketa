  ...
  return (
    <Layout
      ...
      actions={
        <Link
          to="/leave-operations"
          className="inline-flex items-center gap-2 rounded-full border border-zinc-200/90 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 px-3 py-2 text-sm font-medium text-zinc-800 dark:text-zinc-200 shadow-sm hover:bg-zinc-50 dark:hover:bg-zinc-800/50"
        >
    ...
    >
      <div className="max-w-xl space-y-6">
        <div className="flex gap-3 rounded-[20px] bg-zinc-50/80 dark:bg-zinc-800/50 p-4 ring-1 ring-zinc-200/80 dark:ring-zinc-700">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 ring-1 ring-zinc-200/80 dark:ring-zinc-700">
        ...
        <form
          onSubmit={onSubmit}
          className="space-y-5 rounded-[20px] bg-white dark:bg-zinc-900 p-6 shadow-sm ring-1 ring-zinc-950/[0.06] dark:ring-zinc-800"
        >
          <div>
            ...
            <div className="flex flex-col gap-2">
              {modeOptions.map((o) => (
                <label
                  key={o.value}
                  className="flex items-center gap-2 text-sm text-zinc-800 dark:text-zinc-200 cursor-pointer"
                >
                  <input
                    type="radio"
                    name="bulkScope"
          ...
          {mode === "ids" && (
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-zinc-200 dark:border-zinc-800 px-3 py-2 text-sm font-mono"
              />
            </div>
          )}

          {mode === "all" && (
            <label className="flex items-start gap-2 text-sm text-zinc-800 dark:text-zinc-200 cursor-pointer">
              <input
                type="checkbox"
                checked={confirmAll}
        ...
        {lastResult && (
          <div className="rounded-[20px] bg-zinc-50/90 dark:bg-zinc-800/50 px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 ring-1 ring-zinc-200/80 dark:ring-zinc-700">
            <p className="font-semibold text-zinc-900 dark:text-zinc-100">Last result</p>
